...
import 'package:comp_flutter/ui/exam/year_selector.dart';
...
import 'package:sgela_shared_widgets/util/toasts.dart';
...
class SubjectSearchState extends State<SubjectSearch> {
  ...
  final Set<String> _selectedButton = {modelGeminiAI};
  ...
  _navigateToYearSelectorList(BuildContext context, Subject subject) {
    NavigationUtils.navigateToPage(
        context: context,
        widget: YearSelector(
          subject: subject,
  ...
  void _navigateToGeminiMultiTurnChat() {
    prefs.saveCurrentModel(modelGeminiAI as Model);
  ...
  Widget build(BuildContext context) {
    ...
    var isDark = isDarkMode(prefs, Theme.of(context).brightness);
                  ...
                  child: bd.Badge(
                    ...
                    child: busy
                        ? const Padding(
                            ...
                            child: BusyIndicator(
                                caption:
                                    'Loading subjects ... just a second ...'),
                          )
                        : Padding(
                            padding: const EdgeInsets.all(8.0),
